    ...
    margin-bottom: 10px; background: rgba(0,0,0,.1);">
        ...
        <div class="map-box map-center p-relative">
            ...
            <div class="map-tootip p-absolute">
                    ...
                    <li class="tiplist"><span class="map-icon map-event level-offline"></span><p>离线<span>{{totilnum-online}}</span>头</p></li>
            </div>
        </div>
...
<script>
    ...
    import {bankWarningList,getMonthAgeStatis, bankAmountCount, getImmuneStatis, queryDiseaseCountByCp, bankCattleSpecies,cpRealTimePreview,cattlecount} from '@/libs/api'
