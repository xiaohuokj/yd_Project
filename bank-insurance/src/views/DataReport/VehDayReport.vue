<template>
    <div class="wrap-main" id="superviseWraper" :style="{height: tableHeight}">
        ...
        <div class="report-title">{{governmentName}}机械清保作业日报</div>
        ...
        <cui-table class="report-table" border="true" ref="accountTable" :tableConfigs="tableConfigs">
            <template slot="sweepWorkRatio" slot-scope="scope">
                <span v-if="scope.row.sweepWorkRatio != null">{{scope.row.sweepWorkRatio}}%</span>
            </template>
            <template slot="waterWorkRatio" slot-scope="scope">
                <span v-if="scope.row.waterWorkRatio != null">{{scope.row.waterWorkRatio}}%</span>
            </template>
        </cui-table>
    ...
    export default{
        ...
        data() {
            return {
                ...
                reportDate:'',
                tableConfigs:{
                    url:'/supervise/report/daily/vehPage',
