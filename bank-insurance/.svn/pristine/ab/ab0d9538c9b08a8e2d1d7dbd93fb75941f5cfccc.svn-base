<template>
  <div class="map-operator">
    <div class="btnToggle" @click="showMarker">
      <i class="markerShow markerShowBgimg"></i>
      <span class="btntxt btntxt_1">牛只</span>
    </div>
    <b class="liners"></b>
    <div class="btnToggle" @click="Enclosure">
      <i class="autoFullstatus autoFullstatusBgimg"></i>
      <span class="btntxt btntxt_2">围栏</span>
    </div>
    <!--<div class="btnToggle" @click="fullScreen">
      &lt;!&ndash;<div>{{fullStatus ? '适应屏' : '全屏'}}</div>&ndash;&gt;
      <i class="autoFullstatus"></i>
      <span class="btntxt">适应屏</span>
    </div>-->
    <!--<div @click="bind">
      <div>step：{{step}}</div>
    </div>
...
<style scoped>
  ...
  .liners {
    ...
    width: 0;
    height: 18px;
    border-right:1px dotted #DBDEE2;
    display: block;
  ...
  .markerShowBgimg {
    background-image: url("icon/cowicon_y.png");
  }
  .autoFullstatusBgimg {
    background-image: url("icon/weilan_y.png");
  }

  .markerShowBgimgActive {
    background-image: url("icon/cowicon_n.png");
  }
  .autoFullstatusBgimgActive {
    background-image: url("icon/weilan_n.png");
  }
  /*.map-operator > div {
